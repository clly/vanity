...
// staticVanityTmpl reads file data from disk. It returns an error on failure.
func staticVanityTmpl() (*asset, error) {
	path := "/home/connor/go/src/github.com/clly/vanity/static/vanity.tmpl"
	name := "static/vanity.tmpl"
...
var _bindata = map[string]func() (*asset, error){
	"static/vanity.tmpl": staticVanityTmpl,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"static": &bintree{nil, map[string]*bintree{
		"vanity.tmpl": &bintree{staticVanityTmpl, map[string]*bintree{}},
	}},
}}
